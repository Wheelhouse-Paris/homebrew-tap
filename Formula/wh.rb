class Wh < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Wheelhouse-Paris/wheelhouse/releases/download/v0.1.0-alpha.6/wh-aarch64-apple-darwin"
      sha256 "9f5e1adc0838c3bdabbeafdf7f19c9284ec1e21f48ac53cb69422faf4ae839c0"
    end
  end
