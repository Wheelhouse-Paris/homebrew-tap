class Wh < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Wheelhouse-Paris/wheelhouse/releases/download/v0.1.0-alpha.12/wh-aarch64-apple-darwin.tar.gz"
      sha256 "6b806eaaf15f45131379b2ac835839ce9317f98ce9ec1c83cf69385f29ad1ae5"
    end
  end
