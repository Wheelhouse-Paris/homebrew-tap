class Wh < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Wheelhouse-Paris/wheelhouse/releases/download/v0.1.0-alpha.10/wh-aarch64-apple-darwin.tar.gz"
      sha256 "93b4aaf5c43db61a51a60826135d31f5844684f1a838ba215ef7201a6190362f"
    end
  end
