class Wh < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Wheelhouse-Paris/wheelhouse/releases/download/v0.1.0-alpha.13/wh-aarch64-apple-darwin.tar.gz"
      sha256 "a993cb2c7ea68ef91fc117c34a7e8c0b3c33aa2508c0fe2ce9520281df2f6018"
    end
  end
