class Wh < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Wheelhouse-Paris/wheelhouse/releases/download/v0.1.9-alpha/wh-aarch64-apple-darwin.tar.gz"
      sha256 "4b8b2121fa453754ab403a0c8a5ad42057ad386a8297fc99a988c1736fd85b00"
    end
  end
